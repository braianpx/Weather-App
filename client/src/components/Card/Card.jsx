...
const removeCity = () => {
    ...
    return(
        <div id={fadingRemove?"idCardFading":"idCard"} className="card m-sm-5 my-3" >
            ...
            <div style={{zIndex:"-1 !important"}} id="idTextDark" className="card-body w-100 h-50 text-center text-white row row-cols-2 align-content-end mt-0 p-1" >
